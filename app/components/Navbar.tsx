      ...
      <nav className="sticky top-0 z-50 border-b border-[var(--border)] bg-[var(--bg-secondary)]/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          ...
          <button
            ...
            className={`flex h-10 w-10 items-center justify-center rounded-lg border bg-[var(--bg-primary)] md:hidden transition-colors ${
        ...
        >
          <div className="rounded-3xl border border-[var(--border)] bg-[var(--bg-secondary)]/90 backdrop-blur-2xl p-4 shadow-2xl">
            <div className="flex flex-col gap-3">
              ...
              <button
                onClick={toggleDarkMode}
                className="flex items-center justify-between rounded-2xl border border-[var(--border)] bg-[var(--bg-primary)] px-4 py-3 text-sm font-medium text-[var(--text-primary)] transition-colors hover:border-[var(--accent)] hover:shadow-sm"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-[var(--accent)] to-violet-500 px-4 py-3.5 text-sm font-medium text-white shadow-md transition-all hover:brightness-110 hover:shadow-lg dark:from-white dark:to-gray-200 dark:text-black w-full"
              >
                <Plus size={18} />
                Create Event
              </button>
